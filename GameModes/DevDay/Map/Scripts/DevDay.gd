...
#	var val  = Settings.configFile.get_value("DevDay", "SumCollected", null)
#	if val != null:
#		collectedSum = val
#		_setSumPick(val)
...
func _spawnCollectable() -> void:
	var collectableScene = preload("res://GameModes/DevDay/Map/Scenes/Collectable.tscn")
...
#	Settings._saveInSettings("GameModeDay", "SumCollected", val)
